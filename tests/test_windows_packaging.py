...
class WindowsPackagingTest(unittest.TestCase):
    ...
    def test_github_workflow_builds_live_tools_from_unified_web_entry(self):
        ...
        self.assertIn("live-tools-update-internal.json", content)
        self.assertIn("http://stock.seifallspark.com/temp/aiTools/Live-Tools-Windows-v$version.zip", content)
        ...
        self.assertIn("Refusing to publish release without all Windows update assets", content)
